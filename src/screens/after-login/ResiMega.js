        ...
        <ScrollView>
          <View style={[styles.bgWhite]}>
            ...
            <SelectDropdown
              ...
              defaultButtonText="Select an Session"
            ...
            />
            <Button title="Submit" onPress={() => onSearch()} />
          </View>
          {/* Table */}
        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            <ScrollView>
              ...
              <View style={[styles.row, styles.mt10, styles.borderTable]}>
                <Image source={{ uri: baseUrlImage + dataModal }} style={{ height: 500, width: '100%' }} />
              </View>
            </ScrollView>
          </View>
        </View>
